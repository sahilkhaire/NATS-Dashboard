    ...
    <div className="p-6 space-y-4">
      ...
      <div className="flex gap-4 flex-wrap">
        ...
        <select
          ...
          className="bg-nats-card border border-nats-border rounded px-3 py-2 text-sm"
        >
          <option value="cid">ID</option>
          <option value="pending_bytes">Pending</option>
          <option value="in_msgs">Msgs In</option>
          <option value="out_msgs">Msgs Out</option>
